...
median_steps
```
The mean and median of steps taken per day are **`r round(mean_steps,2)`** and **`r median_steps`** respectively
...
daily_median
```
The mean is **`r sprintf("%.2f", daily_mean)`** and the median is **`r sprintf("%.2f", daily_median)`**  
